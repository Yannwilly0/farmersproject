...
@section('content')
 ...
 <div class="container-fluid py-2">
     <h4 class="lead">Create Admin</h4>
     <p>Admin <label class="dot"> > </label> Admins Management <label class="dot"> > </label> Admins <label class="dot"> > </label> Create Admin</p>
    <div class="card list-card">
        <div class="form-header text-white">
            <h5 class="m-3"> <i class="fa fa-plus-circle" aria-hidden="true"></i> CREATE ADMIN</h5>
        </div>
        <div class="container py-3 mb-3">
            <form method="POST" action="{{route('admin.admins.registration')}}" enctype="multipart/form-data">
              @csrf
                <div class="form-row">
